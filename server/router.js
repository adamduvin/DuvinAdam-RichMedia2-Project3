...
const router = (app) => {
  ...
  //app.post('/player', mid.requiresLogin, controllers.Character.make);
  app.get('/gm', mid.requiresLogin, controllers.Character.makerPage);
  app.post('/gm', mid.requiresLogin, controllers.Character.make);
